...
import { storageArrayAliveSave } from "./storage";
...
export default function App() {
  ...
  const form = document.getElementById(`${config.classForm}`) as HTMLElement;
  ...
  table.addEventListener("click", (event) =>
    handlerTableClick(event, table, buttonStart, buttonClear)
  );
